...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget_9 = QtWidgets.QWidget(parent=self.paramsDataFrame)
        self.verticalLayoutWidget_9.setGeometry(QtCore.QRect(0, 0, 481, 361))
        ...
        self.ParamsLabel = QtWidgets.QLabel(parent=self.verticalLayoutWidget_9)
        ...
        self.backpackValueLabel = QtWidgets.QLabel(parent=self.verticalLayoutWidget_9)
        self.backpackValueLabel.setObjectName("backpackValueLabel")
        self.algParams.addWidget(self.backpackValueLabel)
        self.backpackValueLE = QtWidgets.QLineEdit(parent=self.verticalLayoutWidget_9)
        ...
        self.genAmountLabel = QtWidgets.QLabel(parent=self.verticalLayoutWidget_9)
        self.genAmountLabel.setObjectName("genAmountLabel")
        self.algParams.addWidget(self.genAmountLabel)
        self.generationAmountLE = QtWidgets.QLineEdit(parent=self.verticalLayoutWidget_9)
        ...
        self.entityAmountLabel = QtWidgets.QLabel(parent=self.verticalLayoutWidget_9)
        self.entityAmountLabel.setObjectName("entityAmountLabel")
        self.algParams.addWidget(self.entityAmountLabel)
        self.entityAmountLE = QtWidgets.QLineEdit(parent=self.verticalLayoutWidget_9)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.probabilityCrossingLabel = QtWidgets.QLabel(parent=self.verticalLayoutWidget_9)
        ...
        self.crossingProbabilitySpin = QtWidgets.QDoubleSpinBox(parent=self.verticalLayoutWidget_9)
        ...
        self.probabilityCrossingLabel_2 = QtWidgets.QLabel(parent=self.verticalLayoutWidget_9)
        ...
        self.mutationProbabilitySpin = QtWidgets.QDoubleSpinBox(parent=self.verticalLayoutWidget_9)
        ...
        self.line_2 = QtWidgets.QFrame(parent=self.verticalLayoutWidget_9)
        ...
        self.parent_selection_method_label = QtWidgets.QLabel(parent=self.verticalLayoutWidget_9)
        ...
        self.parent_selection_comboBox = QtWidgets.QComboBox(parent=self.verticalLayoutWidget_9)
        ...
        self.crossing_method_label = QtWidgets.QLabel(parent=self.verticalLayoutWidget_9)
        self.crossing_method_label.setObjectName("crossing_method_label")
        self.params_layout_2.addWidget(self.crossing_method_label)
        self.crossing_method_comboBox = QtWidgets.QComboBox(parent=self.verticalLayoutWidget_9)
        ...
        self.mutation_method_label = QtWidgets.QLabel(parent=self.verticalLayoutWidget_9)
        self.mutation_method_label.setObjectName("mutation_method_label")
        self.params_layout_2.addWidget(self.mutation_method_label)
        self.mutation_method_comboBox = QtWidgets.QComboBox(parent=self.verticalLayoutWidget_9)
        ...
        self.methodOfSelectingIndividsLabel = QtWidgets.QLabel(parent=self.verticalLayoutWidget_9)
        ...
        self.methodOfSelectingIndividsComboBox = QtWidgets.QComboBox(parent=self.verticalLayoutWidget_9)
        ...
        self.saveButton = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_9)
        ...
        self.plainTextEdit = QtWidgets.QPlainTextEdit(parent=self.instructionTab_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.crossing_method_comboBox.setCurrentText(_translate("MainWindow", "Равномерное скрещивание"))
        self.crossing_method_comboBox.setItemText(0, _translate("MainWindow", "Равномерное скрещивание"))
        ...
        self.mutation_method_comboBox.setCurrentText(_translate("MainWindow", "Плотность мутации"))
        ...
        self.plainTextEdit.setPlainText(_translate("MainWindow", "Данное приложение решает задачу о неограниченном рюкзаке с помощью генетического алгоритма.\n"
"\n"
"Кнопка *изменить* в области \"Параметры работы алгоритма\" позволяет применить внесённые изменения в параметры работы алгоритма.\n"
"Кнопка *запуск* позволяет запустить алгоритм с выбранными характеристиками и выбранными данными. До выбора данных кнопка неактивна. Повторное нажатие кнопки перезапускает алгоритм с теми же параметрами и данными.\n"
"Кнопки *шаг вперёд* и *шаг назад* позволяют рассмотреть соответственно следующую и предыдущую итерации алгоритма. Кнопка *результат* позволяет рассмотреть результат работы алгоритма, т.е. его последнюю итерацию.\n"
"\n"
"\n"
"*Параметры работы алгоритма*:\n"
"Допустимый вес рюкзака - наибольший вес совокупности предметов, которые можно поместить в рюкзак. Варьируется от 1 до 999.\n"
"Количество поколений - количество итераций, которые проведёт алгоритм. Чем число больше, тем больше шансов на нахождение истинного решения. Варьируется от 1 до 999 (тут стоило бы поправить на 99).\n"
"Количество особей в поколении - количество рюкзаков с вещами, которые рассматриваются на одной итерации алгоритма. Большое число способствует большему разнообразию внутри поколения, а значит и повышению вероятности нахождения верного решения.\n"
"Вероятность скрещивания - вероятность того, что между двумя родителями, отобранными определённым \"способом отбора родителей\", произойдёт скрещивание согласно \"способу скрещивания\". Высокая вероятность скрещивания благоприятно влияет на разнообразие внутри поколения. Рекомендованный диапозон значений от 0.5 до 0.9.\n"
"Вероятность мутации - вероятность того, что потомок, полученный в результате срещивания мутирует согласно \"способу мутации\". Мутация позволяет зародиться в поколении принципиально новому решению. Высокая вероятность мутации понижает скорость сходимости алгоритма, но позволяет с большей вероятностью найти истинное решение.\n"
...
"Кнопка *Загрузить из файла* окрывает окно проводника для выбора файла .txt для загрузки данных. Файл должен содержать 2 числа на каждой строке - цену и вес."))
