...
class Selection(AlgorithmDataAndCommonMethods):
    def __init__(self, items: list[Item], algorithmParameters: AlgorithmParameters):
        ...
        self.selectionWays = {'tournamentSelection': self.tournamentSelection, 'eliteSelection': self.eliteSelection}
...
class Crossing(AlgorithmDataAndCommonMethods):
    def __init__(self, items: list[Item], algorithmParameters: AlgorithmParameters):
        super().__init__(items, algorithmParameters)
        self.crossingWays = {'uniformCrossing': self.uniformCrossing}
...
class Mutation(AlgorithmDataAndCommonMethods):
    def __init__(self, items: list[Item], algorithmParameters: AlgorithmParameters):
        super().__init__(items, algorithmParameters)
        self.mutationWays = {'densityMutation': self.densityMutation}
...
if __name__ == '__main__':
    ...
    wayOfParentsSelection = 'tournamentSelection'
    wayOfCrossing = 'uniformCrossing'
    wayOfMutation = 'densityMutation'
    wayOfNewGenerationSelection = 'eliteSelection'
